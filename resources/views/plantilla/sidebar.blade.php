<div class="sidebar">
                <nav class="sidebar-nav">
                    <ul class="nav">
                        ...
                        <li class="nav-item nav-dropdown">
                            <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-bag"></i> Personas</a>
                            <ul class="nav-dropdown-items">
                                <li @click="menu=3"  class="nav-item">
                                    <a class="nav-link" href="/usuarios"><i class="icon-bag"></i> Usuarios</a>
                                </li>
                                <li @click="menu=4"  class="nav-item">
                                    <a class="nav-link" href="/usuarios"><i class="icon-bag"></i> Proveedores</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item nav-dropdown">
